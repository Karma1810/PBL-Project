                ...
                <div data-animate-effect="fadeInLeft">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <?php echo '<img class="d-block w-100" src="'.$rows['p_photo1'].'" alt="Third slide">';?>
                            </div>
                            <div class="carousel-item">
                            <?php echo '<img class="d-block w-100" src="'.$rows['p_photo2'].'" alt="Third slide">';?>
                            </div>
                            <div class="carousel-item">
                            <?php echo '<img class="d-block w-100" src="'.$rows['p_photo3'].'" alt="Third slide">';?>
                            </div>
                        </div>
